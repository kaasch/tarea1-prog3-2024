...
const myOwnFunction = songs.filter((song) => song.year > 1980);
console.log("20", `${title} by ${artist} - ${year}`);

const totalNumber = myOwnFunction.reduce((acc, curr) => acc + curr.year, 0);
console.log("20", totalNumberYears);
